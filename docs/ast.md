...
- `VFilterSequenceExpression` is an expression node for Kdu.js Filters syntax.
...
This supports only HTML for now. However, I'm going to add other languages Kdu.js supports. The AST of other languages may be different form to VElement.
